...
## Description
This team project is part of the ALX programme foundations.
...
* All files were created and compiled on Ubuntu 20.04 LTS using GCC 12.2.0 with the command ```gcc -Wall -Werror -Wextra -pedantic *.c```
